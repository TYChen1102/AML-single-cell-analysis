...
d <- read.table("AML_res/AML707B/AML707B_RNN_after.csv", sep=",", header=TRUE)
id <- read.table("AML_res/AML707B/AML707B_predict.csv", sep=",", header=TRUE)
...
raw <- read.table("AML_data/AML707B/AML707B-all_data.csv", sep="\t", header=TRUE)
cells <- read.table("AML_data/AML707B/AML707B_celltype_merge.csv", sep="\t", header=TRUE)
...
d$pre[d$id=="5"] <- "Prog & GMP"
d$pre[d$id=="6"] <- "T"
d$pre[d$id=="7"] <- "Prog & GMP"
d$pre[d$id=="8"] <- "Mono"
d$pre[d$id=="9"] <- "Ery"
d$pre[d$id=="10"] <- "Plasma & B"
d$pre[d$id=="11"] <- "Prog & GMP"
...
used.marker <- c("HBB", "AHSP", "CA2", "HBD", "CLEC11A", "PRSS57", "EGFL7", "SOX4", "CD34", "LYZ", "CD14", "GNLY", "GZMB", "GZMA", "NKG7", "MS4A1", "FCRLA", "FCRL5", "MZB1", "IL7R", "CD3D", "CCR7")
used.marker <- c("HBB", "CA2", "CLEC11A", "PRSS57", "LYZ", "CD14", "NKG7", "MS4A1", "FCRLA", "FCRL5", "MZB1", "IL7R", "CD3D")
marker <- genelist.new
marker[!marker %in% used.marker] <- " "
...
#days <- c(rep("D0",1586),rep("D18",1673),rep("D41",387),rep("D97",84),rep("D113",708))
days <- read.table("AML_data/AML707B/AML707B-all_days_1.csv", sep="\t", header=TRUE)
...
p <- p + theme(axis.text=element_text(size=15), axis.title=element_text(size=15), legend.text = element_text(size=15), legend.title = element_text(size=15), panel.grid.major=element_line(colour=NA), panel.background = element_rect(fill = "transparent",colour = NA), plot.background = element_rect(fill = "transparent",colour = NA), panel.grid.minor = element_blank())
p <- p + labs(x = "t-SNE1", y = "t-SNE2")
p <- p + scale_colour_manual(values=c("red", "gray"),breaks = c("TRUE","FALSE"), labels = c("D0 (661 cells)","1864 cells"))
p

p <- ggplot(data = d) + geom_point(mapping = aes(x = tSNE1,y = tSNE2, color = d18), size = 1)
p <- p + guides(color=guide_legend(title = NULL)) + theme_bw()
p <- p + theme(axis.text=element_text(size=15), axis.title=element_text(size=15), legend.text = element_text(size=15), legend.title = element_text(size=15), panel.grid.major=element_line(colour=NA), panel.background = element_rect(fill = "transparent",colour = NA), plot.background = element_rect(fill = "transparent",colour = NA), panel.grid.minor = element_blank())
p <- p + labs(x = "t-SNE1", y = "t-SNE2")
p <- p + scale_colour_manual(values=c("red", "gray"),breaks = c("TRUE","FALSE"), labels = c("D18 (762 cells)","1864 cells"))
p

p <- ggplot(data = d) + geom_point(mapping = aes(x = tSNE1,y = tSNE2, color = d41), size = 1)
p <- p + guides(color=guide_legend(title = NULL)) + theme_bw()
p <- p + theme(axis.text=element_text(size=15), axis.title=element_text(size=15), legend.text = element_text(size=15), legend.title = element_text(size=15), panel.grid.major=element_line(colour=NA), panel.background = element_rect(fill = "transparent",colour = NA), plot.background = element_rect(fill = "transparent",colour = NA), panel.grid.minor = element_blank())
p <- p + labs(x = "t-SNE1", y = "t-SNE2")
p <- p + scale_colour_manual(values=c("red", "gray"),breaks = c("TRUE","FALSE"), labels = c("D41 (150 cells)","1864 cells"))
p

p <- ggplot(data = d) + geom_point(mapping = aes(x = tSNE1,y = tSNE2, color = d97), size = 1)
p <- p + guides(color=guide_legend(title = NULL)) + theme_bw()
p <- p + theme(axis.text=element_text(size=15), axis.title=element_text(size=15), legend.text = element_text(size=15), legend.title = element_text(size=15), panel.grid.major=element_line(colour=NA), panel.background = element_rect(fill = "transparent",colour = NA), plot.background = element_rect(fill = "transparent",colour = NA), panel.grid.minor = element_blank())
p <- p + labs(x = "t-SNE1", y = "t-SNE2")
p <- p + scale_colour_manual(values=c("red", "gray"),breaks = c("TRUE","FALSE"), labels = c("D97 (32 cells)","1864 cells"))
p
...
p <- p + theme(axis.text=element_text(size=15), axis.title=element_text(size=15), legend.text = element_text(size=15), legend.title = element_text(size=15), panel.grid.major=element_line(colour=NA), panel.background = element_rect(fill = "transparent",colour = NA), plot.background = element_rect(fill = "transparent",colour = NA), panel.grid.minor = element_blank())
p <- p + labs(x = "t-SNE1", y = "t-SNE2")
p <- p + scale_colour_manual(values=c("red", "gray"),breaks = c("TRUE","FALSE"), labels = c("D113 (259 cells)","1864 cells"))
p
...
days.matrix <-within(days.matrix,{days <-factor(days,levels=c("D0","D18","D41","D97","D113"))})
days.matrix$Freq[days.matrix$days == "D0"] <- days.matrix$Freq[days.matrix$days == "D0"]/sum(d$d0)
days.matrix$Freq[days.matrix$days == "D18"] <- days.matrix$Freq[days.matrix$days == "D18"]/sum(d$d18)
days.matrix$Freq[days.matrix$days == "D41"] <- days.matrix$Freq[days.matrix$days == "D41"]/sum(d$d41)
days.matrix$Freq[days.matrix$days == "D97"] <- days.matrix$Freq[days.matrix$days == "D97"]/sum(d$d97)
...
d.mut <-within(d.mut,{days <-factor(days,levels=c("D0","D18","D41","D97","D113"))})
...
p <- p + ylab("Cell typess") + xlab("Samples")
p
...
d <-within(d,{days <-factor(days,levels=c("D0","D18","D41","D97","D113"))})
...
d.after <- read.table("AML_res/AML707B/AML707B_RNN_after.csv", sep=",", header=TRUE)
d.ori <- read.table("AML_res/AML707B/AML707B_RNN_before.csv", sep=",", header=TRUE)
